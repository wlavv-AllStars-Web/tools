...
@section('content')
@include('partials.breadcrumbs', ['breadcrumbs'=>[['name'=>trans('web'),'url'=>route('web.index')],['name'=>'Stock audit','url'=>route('web.tools.stock_audit.index'),'no_translation'=>true]]])
...
<div class="card mb-3"><div class="card-body"><form class="row g-2">
 <div class="col-md-4"><input name="reference" value="{{ $filters['reference'] ?? '' }}" class="form-control" placeholder="Referência"></div>
...
<div class="card"><div class="card-header">Movimentos</div><div class="table-responsive"><table class="table mb-0"><thead><tr><th>Data</th><th>Referência</th><th>Origem</th><th>Quantity</th><th>Stock arrive</th></tr></thead><tbody>
