<div class="navbar navbar-light customPanel categorList">
    <div onclick="$('#newProductIssueContainer').toggle();" style="cursor: pointer;">
        ADD NEW PRODUCT ISSUE ?
    </div>
    <div id="newProductIssueContainer" style="display: none;">
        <form id="myform" action="{{ route('productIssues.store') }}" method="POST" class="p-3">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                    ...
                    <div style="margin-bottom: 20px;height: 60px;">
                        ...
                        <div class="form-check" style="width: 33%; float: left;">
                            <input type="checkbox" name="assembly" id="assembly" value="1" class="form-check-input">
                            <label class="form-check-label" for="assembly">ASSEMBLY</label>
                        </div>
                        <div class="form-check" style="width: 33%; float: left;">
                            <input type="checkbox" name="compatibility" id="compatibility" value="1" class="form-check-input">
                            <label class="form-check-label" for="compatibility">COMPATIBILITY</label>
                        </div>
                        <div class="form-check" style="width: 33%; float: left;">
                            <input type="checkbox" name="defect" id="defect" value="1" class="form-check-input">
                            <label class="form-check-label" for="defect">DEFECT</label>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="id_order">ID ORDER</label>
                        <input type="number" name="id_order" id="id_order" value="" class="form-control">
                    </div>
                    <div class="mb-3">
