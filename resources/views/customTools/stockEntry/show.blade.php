...
@section('content')
    ...
    <div class="navbar navbar-light customPanel" style="max-width: 500px;">
        ...
        <div style="width: 100%;display: none;" id="mainContainer">
            <div style="text-align:center;"> <span style="padding: 5px 0; font-size: 18px;">REFERENCE: </span> <span id="tag_product_reference" style="padding: 5px; font-size: 18px;font-weight: bold;color: red;"></span></div>
            <hr>
                        ...
                        <form name="measurementsForm" id="measurementsForm" method="POST" action="#">
                            ...
                            <table style="max-width: 100%;margin: 0 auto;">
                                <tr style="height: 40px;">
                                    ...
                                    <td> <input type="checkbox" id="multiboxMeasurementsForm" name="multibox" value="1" style="margin-left: 10px;height: 25px;width: 25px;"></td>
                                </tr>
                                <tr style="height: 40px;">
