            ...
            <table class="display" style="width:100%;text-align: center;">
                ...
                <tbody>
                    @foreach($data AS $item)
                        <tr onclick="getSupplierOrders({{$item->supplier->id_supplier}}, 1)" style="cursor: pointer" class="supplierRow">
    ...
    <div style="width: calc( 100% - 370px); margin-left: 20px; float: left;">
        <div class="navbar navbar-light customPanel" style="display: flex;">
            <div id="suppliersOrders" style="width: 100%;">
                <div class="alert alert-warning" style="margin-bottom: 0;">SELECT SUPPLIER ON THE LEFT TO SHOW OPEN ORDERS</div>
            </div>
        </div>    
    </div>    
</div>