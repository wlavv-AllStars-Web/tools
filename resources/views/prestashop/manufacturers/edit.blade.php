    ...
    <form name="manufacturersForm" id="manufacturersForm" method="POST" action="{{route('manufacturers.update', $manufacturer->id_manufacturer)}}">
        ...
        <div class="navbar navbar-light customPanel">
            ...
            <div class="row">
                ...
                <div class="col-lg-10"><input class="customInput" type="text" name="name" value="{{$manufacturer->name}}"></div>
            </div>
            <div class="row">
                <div class="col-lg-2 text-right"><label class="showInfo">{{ __('messages.warranty')}}: </label></div>
                <div class="col-lg-10"><input class="customInput" type="text" name="warranty" value="{{$manufacturer->warranty}}"></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-10"><label class="showInfo"><input type="checkbox" name="active" @if($manufacturer->active == 1) checked @else @endif value="1"></div>
            </div>
        </div>
        ...
        <div class="navbar navbar-light customPanel">
            ...
            <div class="row">
                ...
                <div class="col-lg-10"><input class="customInput" type="text" name="short_description[{{$lang->id_lang}}]" value="{{$lang->short_description}}"></div>
            </div>
            <div class="row">
