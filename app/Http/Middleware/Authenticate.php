...
class Authenticate extends Middleware
{
    ...
    public function handle($request, Closure $next, ...$guards){        
        ...
        $ids[59] = (object)[ 'asm' => 59,  'asd' => 8,       'name' => 'Margarida' ];
        $ids[62] = (object)[ 'asm' => 62,  'asd' => 0,       'name' => 'Ricardo' ];
        $ids[67] = (object)[ 'asm' => 67,  'asd' => 0,       'name' => 'Patricia' ];
        $ids[75] = (object)[ 'asm' => 75,  'asd' => 21,      'name' => 'Helio' ];
        $ids[78] = (object)[ 'asm' => 78,  'asd' => 27,      'name' => 'Pierre' ];
        $ids[81] = (object)[ 'asm' => 81,  'asd' => 26,      'name' => 'Sofia' ];
        $ids[85] = (object)[ 'asm' => 85,  'asd' => 30,      'name' => 'Rosario' ];
        $ids[88] = (object)[ 'asm' => 88,  'asd' => 42,      'name' => 'Sandra' ];
        $ids[92] = (object)[ 'asm' => 92,  'asd' => 38,      'name' => 'Daniel' ];
        $ids[94] = (object)[ 'asm' => 9,   'asd' => 3,       'name' => 'Luduvina' ];
