...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><div class="navbar navbar-light customPanel"><button style="width: 100%;" type="button" class="btn btn-dark" onclick="clearFrontofficeMenu()"> CLEAR FRONT MENU </button> </div> </div>
        <div class="col-lg-1"></div>
    </div>
