...
class AppServiceProvider extends ServiceProvider
{
    ...
    private function fallbackBreadcrumbs(): array
    {
        ...
        return match ($routeName) {
            ...
            'stats.adminKpi' => $this->areaBreadcrumbs('dashboard', 'dashboard.index', 'KPI'),
            'logs.index',
    ...
    private function fallbackRoutePrefixMap(): array
    {
        return [
            ...
            'dashboard.tools.adminKpi' => ['dashboard', 'dashboard.index', 'KPI'],
            'dashboard.tools.changes' => ['dashboard', 'dashboard.index', 'Changes'],
            'web.tools.resources.asm.' => ['web', 'web.index', 'ASM resources'],
            'web.tools.resources.asd.' => ['web', 'web.index', 'ASD resources'],
            ...
            'logistics.tools.carrier_end_of_day.' => ['logistics', 'logistics.index', 'Carrier end of day'],
